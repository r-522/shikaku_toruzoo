    ...
    <div class="card-body py-3">
      ...
      <div class="d-flex justify-content-between align-items-start">
        ...
        <div class="flex-grow-1">
          <!-- 資格名とステータスバッジ -->
          <!-- min-width:0 + text-truncate: 長い資格名がバッジを押し出さないよう省略 -->
          <div class="d-flex align-items-center gap-2 mb-1">
            <span class="fw-bold text-truncate flex-shrink-1" style="min-width: 0">{{ goal.certification_name }}</span>
            <!-- flex-shrink-0: バッジは常に表示 -->
            <StatusBadge :status="goal.status" class="flex-shrink-0" />
          </div>

          <!-- 目標日・残り日数・勉強時間（flex-wrap: モバイルで折り返し対応） -->
